...
public class Spiel extends Observable implements SerialisierungsKontext {
	...
	public ch.bodesuri.applikation.client.pd.Spieler aktuellerSpieler;
	...
	private IdentityHashMap<ch.bodesuri.pd.spiel.spieler.Spieler, Spieler> spielerRegister;
	public Chat chat;
	...
	public Spiel(Konfiguration konfig) {
		...
		spielerRegister = new IdentityHashMap<ch.bodesuri.pd.spiel.spieler.Spieler, Spieler>();
		spieler = new Vector<Spieler>();
		for (int i = 0; i < spiel.getSpieler().size(); i++) {
			ch.bodesuri.pd.spiel.spieler.Spieler pdSpieler = spiel.getSpieler().get(i);
	 ...
	 * {@link ch.bodesuri.pd.spiel.spieler.Spieler}.
	 *
	 * @param spieler
	 *            Der bekannte PD-Spieler
	 * @return Der gesuchte Applikations-Spieler
	 */
	public Spieler findeSpieler(ch.bodesuri.pd.spiel.spieler.Spieler spieler) {
	...
	public ch.bodesuri.pd.spiel.Spiel getSpiel() {
		return spiel;
	}
