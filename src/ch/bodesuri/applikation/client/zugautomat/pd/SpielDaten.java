...
public class SpielDaten {
	...
	public List<ch.bodesuri.pd.zugsystem.Bewegung> getPdBewegungen() {
		List<ch.bodesuri.pd.zugsystem.Bewegung> pdBewegungen = new Vector<ch.bodesuri.pd.zugsystem.Bewegung>();
