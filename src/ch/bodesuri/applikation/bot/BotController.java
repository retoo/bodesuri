...
public class BotController extends Controller {
	...
	public void zugAufforderung() {
		...
		IdentityHashMap<Karte, ch.bodesuri.applikation.client.pd.Karte> karten = new IdentityHashMap<Karte, ch.bodesuri.applikation.client.pd.Karte>();

		for (ch.bodesuri.applikation.client.pd.Karte k : spiel.spielerIch.getKarten()) {
