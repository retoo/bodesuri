...
import ch.bodesuri.ui.geteiltes.SpielerView;
import ch.bodesuri.ui.ressourcen.BrettXML;
import ch.bodesuri.ui.ressourcen.Icons;
import ch.bodesuri.ui.spiel.brett.felder.Feld2d;
import ch.bodesuri.ui.spiel.brett.felder.FeldMouseAdapter;
import ch.bodesuri.ui.spiel.brett.felder.Figur2d;
import ch.bodesuri.ui.spiel.brett.felder.FigurenManager;
import ch.bodesuri.ui.spiel.brett.felder.NormalesFeld2d;
import ch.bodesuri.ui.spiel.brett.felder.SpielerFeld2d;
import ch.bodesuri.ui.spiel.brett.felder.Feld2d.Feld2dKonfiguration;
...
public class BrettView extends JPanel {
	...
	public BrettView(Steuerung steuerung, Spiel spiel) {
		...
		try {
			brettXML = new BrettXML("/ch/bodesuri/ui/ressourcen/brett.xml");
		} catch (Exception e) {
