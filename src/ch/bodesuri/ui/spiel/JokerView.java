...
import ch.bodesuri.applikation.client.pd.Joker;
...
import ch.bodesuri.ui.spiel.steuerung.KarteMouseAdapter;
import ch.bodesuri.ui.spiel.steuerung.KarteView;
import ch.bodesuri.ui.spiel.steuerung.KartenAuswahl;
...
public class JokerView extends JPanel {
	...
	public void erstelleDeck() {
		kartenDeck = new Vector<ch.bodesuri.applikation.client.pd.Karte>();
		List<ch.bodesuri.pd.regelsystem.Karte> karten = Deck
				.getKartenFuerFarbe(KartenFarbe.Herz);
		for (ch.bodesuri.pd.regelsystem.Karte karte : karten) {
