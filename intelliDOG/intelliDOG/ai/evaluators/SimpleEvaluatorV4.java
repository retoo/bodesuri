...
/**
 * The V4 includes a changed calculation when entering the heaven
 * and a exponential function to measure the own advance.
 */
public class SimpleEvaluatorV4 implements Evaluator {
	...
	private int distanceInHeaven = 10;
