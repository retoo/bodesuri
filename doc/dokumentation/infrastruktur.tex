...
Die Tracseite soll als Startseite angezeigt werden (beim Besuch von bodesuri.speedpc.ch). Dies wird erreicht indem in der Datei \textbf{/etc/apache2/sites-enabled/000-default} folgende Datei die \emph{RewriteRule} auf trac umgeändert wird:
