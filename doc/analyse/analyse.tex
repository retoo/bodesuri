...
\begin{tabular}{@{} l l @{}}
	...
	Nachbedingungen:						& Spieler beigetreten \\
	Häufigkeit des Auftretens:	& Einmal pro Spiel und Spieler \\
\end{tabular}
...
\begin{tabular}{@{} l l @{}}
	...
	Häufigkeit des Auftretens:				& Von einmal pro Woche bis 2--3 Mal pro Jahr \\
\end{tabular}
\newpage
\begin{multicols}{2}
\raggedcolumns
...
\begin{itemize}
	...
	\item Der Spielstand muss nach jedem Zug bei allen Spielern konsistent sein. Inkonsistenzen bzw. Synchronisationsprobleme sollten sofort zu einem kontrollierten Spielabbruch führen.
\end{itemize}
