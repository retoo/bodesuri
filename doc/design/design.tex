...
\subparagraph{Beschreibung des Packages} % (fold)
\label{ssub:beschreibung_des_packages}
Beinhaltet alle Karten und den Kartengeber, welcher die Verwaltungsklasse für die gesamte Handhabung der Karten ist.
% subparagraph beschreibung_des_packages (end)
...
Implementiert die abstrakten Klassen von dienste.serialisierung, um die Serialisierung für die Problem Domain zu ermöglichen.

\subparagraph{Schnittstellen}
Bietet eine Basisklasse (BodesuriCodierbaresObjekt) für die Klassen der PD an, die serialisiert werden können.
