...
%Die logische Sicht beschreibt die Unterteilung der Architektur in die Schichten, Tiers, Packages und Klassen. TODO: Hier fehlt doch Text!!!
...
Alle Spieler müssen mit ihrem Partner eine Karte tauschen. Der Server wartet bis alle Spieler die zu tauschende Karte mit der Nachricht TauscheKarte gemeldet haben. Anschliessend wird die getauschte Karte mit demselben Event dem Partner gemeldet.
...
Der Server wartet auf die Erfassung des Zuges durch den Spieler. Sobald dieser mitgeteilt wurde prüft der Server diesen auf Richtigkeit und verteilt ihn anschliessend an alle Spieler.

% subsubsection warteaufzug (end)

% subsection zustände_server (end)

% subsubsection subsubsection_name (end)

% subsection zustände_client (end)
