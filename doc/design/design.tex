...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.5 \textwidth]{clientServer.png}
	\caption{Kommunikation zwischen Client \& Server}
	\label{fig:legende.png}
\end{figure}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=\textwidth]{pd_kartengeber.png}
	\caption{Kartengeber}
	\label{fig:pd_kartengeber.png}
\end{figure}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=\textwidth]{pd_regelsystem.png}
	\caption{Regelsystem}
	\label{fig:pd_regelsystem.png}
\end{figure}
% subparagraph diagramme (end)
\subparagraph{Schnittstellen} % (fold)
\label{ssub:schnittstellen}
...
\begin{figure}
	\centering
	\includegraphics[width=\textwidth]{pd_validierung.png}
	\caption{Validierung von Spielzügen}
	\label{fig:pd_validierung.png}
\end{figure}
% subparagraph operationen (end)
...
\begin{figure}[h]
	\centering
	\includegraphics[width=\textwidth]{pd_brett.png}
	\caption{Brett und Figuren}
	\label{fig:pd_brett.png}
\end{figure}
% subparagraph diagramme (end)
\subparagraph{Schnittstellen} % (fold)
\label{ssub:schnittstellen}
...
\begin{figure}
	\centering
	\includegraphics[width=\textwidth]{dienste_serialisierung.png}
	\caption{Serialisierung}
	\label{fig:dienste_serialisierung.png}
\end{figure}
% subparagraph operationen (end)
...
\begin{figure}[h]
	\centering
	\includegraphics[width=\textwidth]{dienste_partnerschaft_normal_1.png}
	\caption{Normale Partnerschaft - Teil 1 von 2}
	\label{fig:dienste_partnerschaft_normal_1.png}
\end{figure}
\begin{figure}
	\centering
	\includegraphics[width=\textwidth]{dienste_partnerschaft_normal_2.png}
	\caption{Normale Partnerschaft - Teil 2 von 2}
	\label{fig:dienste_partnerschaft_normal_2.png}
\end{figure}
\begin{figure}
	\centering
	\includegraphics[width=\textwidth]{dienste_partner.png}
	\caption{Partner Verhalten}
	\label{fig:dienste_partner.png}
\end{figure}
\begin{figure}
	\centering
	\includegraphics[width=\textwidth]{dienste_rundenstart.png}
	\caption{Rundenstart}
	\label{fig:dienste_rundenstart.png}
\end{figure}
\begin{figure}
	\centering
	\includegraphics[width=0.8 \textwidth]{dienste_client.png}
	\caption{Zustände des Client}
	\label{fig:dienste_client.png}
\end{figure}
\begin{figure}
	\centering
	\includegraphics[width=\textwidth]{dienste_chat.png}
	\caption{Chat Subsystem}
	\label{fig:dienste_chat.png}
\end{figure}
% subparagraph operationen (end)
...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.8 \textwidth]{Externes Design - Verbindung.png}
...
\begin{figure}
	\centering
	\includegraphics[width=0.7 \textwidth]{Externes Design - Lobby.png}
	\caption{Lobby vor dem Spielbeginn}
	\label{fig:Externes_Design.jpg}
\end{figure}
\begin{figure}
	\centering
	\includegraphics[width=0.8 \textwidth]{Externes Design - Spiel.png}
	\caption{Spielbrett}
	\label{fig:Externes_Design.jpg}
\end{figure}
