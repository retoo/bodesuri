...
Der Server wurde auf mehrere Schichten aufgeteilt und ist in mehrere vertikal angeordnete Partitions aufgeteilt. Diese Hierarchie hat sich deshalb als erforderlich erwiesen, da sonst Abhängigkeiten von tieferliegenden zu höhöerliegenden Schichten entstehen würden.
% paragraph multitier_architektur_des_servers (end)
\paragraph{Applikationsschicht}\label{ssub:applikationsschicht} % (fold)
Die Applikationsschicht wurde deshalb eingeführt, weil es wegen der Netzwerkfähigkeit viel Synchronisationsarbeit (z.\,B. für Zustände) gibt. Sie hat folgende Hauptaufgaben:
	\begin{itemize}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.8 \textwidth]{gui_verbindung}
...
\begin{figure}
	\centering
	\includegraphics[width=0.8 \textwidth]{gui_spiel}
	\caption{Spielbrett}
	\label{fig:gui_spiel}
\end{figure}
