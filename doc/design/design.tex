...
In der Lobby k�nnen die Spieler eine Partner f�r das Spiel ausw�hlen. Der Partner wird ausgew�hlt und einen Gruppennamen eingegeben. Nun muss nur noch der ausgew�hlte Partner die Anfrage akzeptieren, um die Gruppe zu bilden. Sobald der Spieler bereit ist, um das Spiel beizutreten w�hlt er im Spielstatus die CheckBox bereit aus. In der Zwischenzeit k�nnen sich die Spieler im Chat unterhalten (Priorit�t 3).
